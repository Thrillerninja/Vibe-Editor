 ...
 */
export default function TreeVisualization({ sentences, onTreeUpdate, setSentences }) {
  console.log('[TreeVisualization] Rendering with', sentences.length, 'sentences');
  
  return (
    <div style={{ width: '100%', height: '100%' }}>
      <ReactFlowProvider>
        <TreeInner sentences={sentences} onTreeUpdate={onTreeUpdate} setSentences={setSentences} />
      </ReactFlowProvider>
    </div>
  );
}