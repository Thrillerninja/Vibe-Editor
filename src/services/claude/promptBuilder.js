...
6. **ADD EMOTION PROPERTY (NEW)**
   - For every grouping node you create (level 2 and above), you MUST include an **"emotion"** property.
...
[
  ...
  {"id": "n1", "level": 2, "title": "Market Surge and Record Profits", "emotion": "POSITIVE", "childIds": ["s1", "s2"]},        // Sentences 0-1
  {"id": "n2", "level": 2, "title": "Labor Market Decline", "emotion": "NEGATIVE", "childIds": ["s3", "s4"]},        // Sentences 2-3
  {"id": "n3", "level": 2, "title": "Cautious Central Bank Response", "emotion": "NEUTRAL", "childIds": ["s5", "s6"]},      // Sentences 4-5

  // Level 3: Group level 2 nodes by related topics (IN DOCUMENT ORDER!)
  {"id": "n4", "level": 3, "title": "Economic Extremes", "emotion": "NEUTRAL", "childIds": ["n1", "n2"]},     // Contains sentences 0-3 (mixed sentiment)
  {"id": "n5", "level": 3, "title": "Monetary Policy & Outlook", "emotion": "NEUTRAL", "childIds": ["n3"]},       // Contains sentences 4-5 (cautious, divided)

  // Level 4: Top level grouping all level 3 nodes
  {"id": "n6", "level": 4, "title": "Overview of Current Economic Status", "emotion": "NEUTRAL", "childIds": ["n4", "n5"]}
]
...
**Key takeaway**:
- **YOU MUST ADD AN "emotion" PROPERTY with the value "POSITIVE", "NEGATIVE", or "NEUTRAL" to ALL grouping nodes (level 2 and up).**
